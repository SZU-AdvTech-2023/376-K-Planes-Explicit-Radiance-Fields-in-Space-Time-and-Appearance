config = {
 ...
 'data_downsample': 2,
#  'data_downsample': 4,
 'data_dirs': ['/home/xuyaojian/dataset/DyNeRF(Plenoptic Video Datasets)/coffee_martini'],
 'contract': False,
 'ndc': True,
 'ndc_far': 2.6,
 'near_scaling': 0.95,
 ...
 'num_steps': 90001, # To set up the importance sampling, you would set data_downsample to 4 and num_steps to 1 in the config you're using. 
#  'num_steps': 1,
 'batch_size': 4096,
